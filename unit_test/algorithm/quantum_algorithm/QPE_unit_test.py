...
from QuICT.core.gate import X, CompositeGate, CRz, CZ, CH, CX, H
from QuICT.simulation.state_vector import StateVectorSimulator


def test_QPE_Rz_phase():
    for proportion in [0.25, 0.5, 0.75]:
        ...
        with state_prep:
            X | state_prep(0)
        proportion_esti = QPE(StateVectorSimulator()).run(
            workbits, trickbits, state_prep, constructor
        )
