...
from QuICT.algorithm.quantum_algorithm.shor.HRS_zip import construct_circuit as HRS_construct_circuit
import logging
...
order_finding_circuit_test_modes = {"BEA":BEA_construct_circuit,"HRS":HRS_construct_circuit}
