...
from QuICT.algorithm.quantum_chemistry.simulation.moleculardata import MolecularData


def test_load():
    data_dir = os.path.dirname(__file__) + \
        "/../../../QuICT/algorithm/quantum_chemistry/simulation/molecular_data/hydrogen_chains/h_6_sto-3g/bond_distance_1.3"
    ...
    data_dir = os.path.dirname(__file__) + \
        "/../../../QuICT/algorithm/quantum_chemistry/simulation/molecular_data/hydrogen_chains/h_6_sto-3g/bond_distance_1.7"
