...
from QuICT.algorithm.quantum_machine_learning.model.VQE.hartree_fock_net import HartreeFockVQENet
...
class HartreeFockVQE():
    """
    Calculating the Hartree-Fock ground energy with VQE. User interface class.
    """
    def __init__(
        self,
        orbitals: int,
        ...
        """Complete Hartree-Fock VQE algorithm process instance.
        ...
        self._seed(seed)
        self.net = HartreeFockVQENet(orbitals, electrons, hamiltonian, self.device)
        self.loss_func = self.net.loss_func
    ...
    def train(
        ...
        self.model_path = (
            "HFVQE_model_" + now if save_model and model_path is None else model_path
        )
