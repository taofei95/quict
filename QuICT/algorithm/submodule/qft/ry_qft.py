...
class ry_QFT(CompositeGate):
    """
        Quantum Fourier Transform using Ry rotations instead of Rz, H (and swap).
    ...
    def __init__(
        ...
        """
            Args:
                ...
                inverse (bool): If True, construct inverse ry qft.
                
                aprrox_level (int): 
                    For approx_level > 0, all rotation angles < ${\pi \over 2^approx_level}$ will be omitted.
                    When approx_level = 0, no approximation and the qft will be exact.
