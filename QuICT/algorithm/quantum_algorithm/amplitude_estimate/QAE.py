...
class QAE:
    ...
    def __init__(
        ...
        if mode=="canonical":
            logging.warning("canonical QAE has lower success rate than expected!")
        self.mode = mode
        self.eps = eps
    ...
    def run(
        ...
        return QAE._RUN_METHOD_OF_MODE[self.mode](eps=self.eps, oracle=oracle, state_preparation=state_preparation,simulator=self.simulator)
