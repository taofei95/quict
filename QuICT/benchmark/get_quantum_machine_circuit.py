...
class QuantumMachineCircuitBuilder:
    ...
    def _ibm_layout(self):
        ...
        edges_list = [
            ...
            [[0, 1], [1, 0], [2, 3], [3, 2], [4, 7], [5, 3], [6, 7], [7, 4],
            [8, 11], [9, 8], [10, 12], [11, 8], [12, 15], [13, 14], [14, 13], [15, 12]],
            [[0, 1], [1, 4], [1, 2], [2, 3], [3, 5], [4, 7], [5, 8], [6, 7], [7, 10],
            [8, 11], [8, 9], [10, 12], [11, 14], [12, 15], [12, 13], [13, 14], [15, 12],
            [15, 18], [19, 16], [19, 20], [19, 22], [21, 18], [21, 23], [23, 27], [24, 25],
            [24, 23], [25, 22]],
            [[0, 1], [1, 4], [1, 2], [2, 3], [3, 5], [4, 7], [5, 8], [6, 7], [7, 10],
            [8, 11], [8, 9], [10, 12], [11, 14], [12, 15], [12, 13], [13, 14], [15, 12],
            [15, 18], [19, 16], [19, 20], [19, 22], [21, 18], [21, 23], [23, 27], [24, 25],
            [24, 23], [25, 22], [25, 26], [27, 28], [28, 29], [30, 3], [30, 31], [31, 32]]
        ]
    ...
    def _guodun_layout(self):
        ...
        layout_66 = Layout.grid_layout(66, unreachable_nodes)
    ...
    def get_machine_cir(self):
        ...
        for type in machine_type:
            ...
            layout_list = self._machine_topology[type]
