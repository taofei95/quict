    ...
    def get_circuit(
        ...
        for field in fields:
            if field in self.__DEFAULT_CLASSIFY["algorithm"]:
                circuit_list = self._circuit_lib.get_algorithm_circuit(field, max_width, max_size, max_depth)
            if field in self.__DEFAULT_CLASSIFY["benchmark"]:
                circuit_list = self._circuit_lib.get_benchmark_circuit(field, max_width, max_size, max_depth)
            if field in self.__DEFAULT_CLASSIFY["instructionset"]:
                circuit_list = self._circuit_lib.get_instructionset_circuit(field, max_width, max_size, max_depth)
            cir_list = []
