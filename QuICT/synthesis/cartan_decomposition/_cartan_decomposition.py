...
class Cartan_decomposition_model(Synthesis):
    def __call__(self, U: np.matrix):
        self.pargs = [U]
        return self

    def build_gate(self) -> Circuit:
        """
        Cartan分解
        :return: 返回电路
        """
...
Cartan_decomposition = Cartan_decomposition_model()
...
if __name__ == '__main__':
    ...
    circuit = Cartan_decomposition.build_gate(U)
