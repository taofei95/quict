...
def uniformly_rotation_cz(
    ...
    Args:
        ...
        is_cx_or_cz_left(bool): is cx/cz left decomposition
    Returns:
        gateSet: the synthesis gate list
    """
    return inner_uniformly_rotation_cz(low, high, z, mapping, True, is_cx_or_cz_left)
...
def uniformlyRyDecompostionRevision(angle_list, mapping=None):
    ...
    return uniformly_rotation_cz(0, n, pargs, mapping)
