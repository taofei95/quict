...
def test_random_simulator(input_path: str, output_path: str,  num_of_qubits: int, init_mapping: List[int], topology):
    ...
    mcts = TableBasedMCTS()
    mcts.test_random_simulation(logical_circuit = circuit, init_mapping = init_mapping, coupling_graph = topology,
                                num_of_gates = 30000, num_of_iterations = 50)
    print(input_path)
...
if __name__ == "__main__":
    ...
    for file_name in small_benchmark:
        ...
        test_random_simulator(input_path, output_path, topology = topology, num_of_qubits = 20, init_mapping = [i for i in range(20)] )