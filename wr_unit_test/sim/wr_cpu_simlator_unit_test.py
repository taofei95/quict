...
from QuICT.core.gate.gate import CCX, H, QFT, CCRz, Measure
from QuICT.simulation.state_vector.cpu_simulator.cpu import CircuitSimulator
from quict.QuICT.simulation.simulator import Simulator

class Testcpusim(unittest.TestCase):
    @classmethod
    def setUpClass(cls): 
        print('CPU Simlator begin!')
    
    @classmethod
    def tearDownClass(cls): 
        print('CPU Simlator finished!')
