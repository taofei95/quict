...
user = User()
user.save_apitoken('8NtlZ0m5PBmlqwYpD5tt8p8682txOHEmcIQJJOboKrS.9FjMxMTN0kjN2EjOiAHelJCL3QTM6ICZpJye.9JiN1IzUIJiOicGbhJCLiQ1VKJiOiAXe0Jye')
layout = Layout.load_file(
    os.path.dirname(os.path.abspath(__file__)) + 
    f"/layout/line3.layout"
)
...
path = "wr_unit_test/machine-benchmark/qasm/adder_multiplier/plus_one_2bit_1.qasm"
cir = load_circuit(path)
cir_t = ins_qcda(cir)
print(quafu_run(cir_t,"plus_add_2_1"))

amp = simu_cir(cir_t)
print(f'plus_one_2bit_1')
print(abs(amp))
